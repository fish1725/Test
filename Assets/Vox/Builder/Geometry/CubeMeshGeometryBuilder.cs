...
{
    public class CubeMeshGeometryBuilder : CubeMeshBuilder
    {
        ...
        protected override void BuildBox(IBlockSet blockSet, Block block, int minX, int minY, int minZ, int maxX, int maxY, int maxZ)
        {
            ...
            for (y = minY; y < maxY; y++)
            {
                for (z = minZ; z < maxZ; z++)
                {
                    ...
                    if (!rotated)
                    {
                        face[0] = new Vector3i(x, y1, z1);
                        face[1] = new Vector3i(x, y2, z1);
                        face[2] = new Vector3i(x, y2, z2);
                        face[3] = new Vector3i(x, y1, z2);
                    }
                    else
                    {
                        face[0] = new Vector3i(x, y2, z1);
                        face[1] = new Vector3i(x, y2, z2);
                        face[2] = new Vector3i(x, y1, z2);
                        face[3] = new Vector3i(x, y1, z1);
                    }
			...
			for (y = minY; y < maxY; y++)
			{
				for (z = minZ; z < maxZ; z++)
				{
					...
					if (!rotated)
					{
						face[0] = new Vector3i(x + 1, y1, z1);
						face[1] = new Vector3i(x + 1, y2, z1);
						face[2] = new Vector3i(x + 1, y2, z2);
						face[3] = new Vector3i(x + 1, y1, z2);
					}
					else
					{
						face[0] = new Vector3i(x + 1, y2, z1);
						face[1] = new Vector3i(x + 1, y2, z2);
						face[2] = new Vector3i(x + 1, y1, z2);
						face[3] = new Vector3i(x + 1, y1, z1);
					}
			...
			for (x = minX; x < maxX; x++)
			{
				for (z = minZ; z < maxZ; z++)
				{
					...
					if (!rotated)
					{
						face[0] = new Vector3i(x1, y + 1, z1);
						face[1] = new Vector3i(x1, y + 1, z2);
						face[2] = new Vector3i(x2, y + 1, z2);
						face[3] = new Vector3i(x2, y + 1, z1);
					}
					else
					{
						face[0] = new Vector3i(x1, y + 1, z2);
						face[1] = new Vector3i(x2, y + 1, z2);
						face[2] = new Vector3i(x2, y + 1, z1);
						face[3] = new Vector3i(x1, y + 1, z1);
					}
			...
			for (x = minX; x < maxX; x++)
			{
				for (z = minZ; z < maxZ; z++)
				{
					...
					if (!rotated)
					{
						face[0] = new Vector3i(x1, y, z1);
						face[1] = new Vector3i(x1, y, z2);
						face[2] = new Vector3i(x2, y, z2);
						face[3] = new Vector3i(x2, y, z1);
					}
					else
					{
						face[0] = new Vector3i(x1, y, z2);
						face[1] = new Vector3i(x2, y, z2);
						face[2] = new Vector3i(x2, y, z1);
						face[3] = new Vector3i(x1, y, z1);
					}
			...
			for (x = minX; x < maxX; x++)
			{
				for (y = minY; y < maxY; y++)
				{
					...
					if (!rotated)
					{
						face[0] = new Vector3i(x1, y1, z + 1);
						face[1] = new Vector3i(x1, y2, z + 1);
						face[2] = new Vector3i(x2, y2, z + 1);
						face[3] = new Vector3i(x2, y1, z + 1);
					}
					else
					{
						face[0] = new Vector3i(x1, y2, z + 1);
						face[1] = new Vector3i(x2, y2, z + 1);
						face[2] = new Vector3i(x2, y1, z + 1);
						face[3] = new Vector3i(x1, y1, z + 1);
					}
			...
			for (x = minX; x < maxX; x++)
			{
				for (y = minY; y < maxY; y++)
				{
					...
					if (!rotated)
					{
						face[0] = new Vector3i(x1, y1, z);
						face[1] = new Vector3i(x1, y2, z);
						face[2] = new Vector3i(x2, y2, z);
						face[3] = new Vector3i(x2, y1, z);
					}
					else
					{
						face[0] = new Vector3i(x1, y2, z);
						face[1] = new Vector3i(x2, y2, z);
						face[2] = new Vector3i(x2, y1, z);
						face[3] = new Vector3i(x1, y1, z);
					}
